...
public class Activity_Show_Post_Aluminio extends AppCompatActivity implements View.OnClickListener {

    TextView tv_titulo_sp_a;
    TextView tv_link_sp_a;
    EditText et_descripcion_sp_a;
    EditText et_procedimiento_sp_a;
    String direccion;

    private String url = "https://webserviceedgar.herokuapp.com/api_aluminio_post?user_hash=12345&action=get&id_aluminio_post=";
    private String url_put = "https://webserviceedgar.herokuapp.com/api_guardado?user_hash=12345&action=put&";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity__show__post__aluminio);

        //inicialización de EditText de la vista
        tv_titulo_sp_a = findViewById(R.id.tv_titulo_sp_a);
        et_descripcion_sp_a = findViewById(R.id.et_descripcion_sp_c);
        et_procedimiento_sp_a = findViewById(R.id.et_procedimiento_sp_a);
        tv_link_sp_a = findViewById(R.id.tv_link_sp_a);
        ...
        direccion="";
        tv_link_sp_a.setOnClickListener(this);
    }
    public void btn_insertOnClick(View view){
        ...
        sb.append("&");
        sb.append("id_aluminio_post="+id_post);
    ...
    private void parseInformation(String jsonResult){
        ...
        for(int i=0;i<jsonArray.length();i++){
            try{
                ...
                tv_titulo_sp_a.setText(titulo);
                et_descripcion_sp_a.setText(descripcion);
                et_procedimiento_sp_a.setText(procedimiento);
                tv_link_sp_a.setText(link_video);
